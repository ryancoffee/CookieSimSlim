...
parser.add_argument('-darkscale', type=float,default=0.001,required=False, help='Scaling for the dark count haze that is independent total intensity')
parser.add_argument('-secondaryscale', type=float,default=0.005,required=False, help='Scaling for the secondary counts as proportion of total intensity')
