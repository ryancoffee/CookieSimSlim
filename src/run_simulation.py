...
parser.add_argument('-n_threads',   type=int, default=2, required=False,help='Number of Threads')
...
parser.add_argument('-n_angles',type=int, default=16, required=False,help='Number of angles')
parser.add_argument('-n_energies',type=int, default=320, required=False,help='Number of energy bins [let be in units of 1/5 eV for now]')
parser.add_argument('-n_images', type=int,default=10, required=False,help='Number of images per thread [default 10]')
parser.add_argument('-drawscale', type=float,default=5.0,required=False, help='Scaling for draws from the distribution, e.g. scale the number of electrons [default 5.0]')
...
parser.add_argument('-sasewidth', type=int,default=10,required=False, help='Scaling for number of sase subspike widths (energy width of sinusoids) [default 10 1/5ths of eV]')
...
parser.add_argument('-centralenergy', type=float,default=160.0,required=False, help='central photon energy [default mid-point]')
parser.add_argument('-centralenergywidth', type=float,default=20.0,required=False, help='central photon energy width [default 20.0 1/5ths of eV]')
parser.add_argument('-centralenergyvar', type=float,default=40.0,required=False, help='central photon energy variation as sinusoid over nthreads')
...
parser.add_argument('-secondaryscale', type=float,default=0.002,required=False, help='Scaling for the secondary counts as proportion of total intensity [default 0.002]')
parser.add_argument('-kickstrength', type=float,default=100,required=False, help='angular streaking kick strength')
parser.add_argument('-kickstrengthvar', type=float,default=0,required=False, help='variation of kick strength due to streaking laser fluctuations')
