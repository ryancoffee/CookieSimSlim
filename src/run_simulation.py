...
parser.add_argument('-sasewidth', type=int,default=4,required=False, help='Scaling for number of sase subspikes (like number of sinusoids) [default 3]')
...
parser.add_argument('-centralenergywidth', type=float,default=4.0,required=False, help='central photon energy width [default 10.0]')
parser.add_argument('-centralenergyvar', type=float,default=4.0,required=False, help='central photon energy variation as sinusoid over nthreads')
...
parser.add_argument('-kickstrength', type=float,default=16,required=False, help='angular streaking kick strength')
