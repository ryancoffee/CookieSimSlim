...
mkdir -p ${opath}
outfile=${opath}/two_sub_pulse_Mar26_2024.h5
...
python3 ./src/run_simulation.py -ofname ${outfile} -n_threads 64 -n_images 8192 -n_angles 16 -n_energies 512 -polstrength 1 -polstrengthvar 1 -centralenergy 256 -centralenergyvar 32 -kickstrength 128 -kickstrengthvar 32 -drawscale 4 -custom_single_energy_sase True -selected_centers 2 -max_num_sase 2
